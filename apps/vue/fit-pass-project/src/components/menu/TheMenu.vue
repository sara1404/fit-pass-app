...
<template>
    <nav>
      ...
      <UserProfileHeader v-show="loggedIn" @displayPromoCodeForm="$emit('displayPromoCodeForm')" @displaySubscriptionForm="$emit('displaySubscriptionForm')" @displayAddObjectForm="$emit('displayAddObjectForm')"/>
    </nav>
</template>
