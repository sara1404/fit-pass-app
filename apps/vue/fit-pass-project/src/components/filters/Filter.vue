  ...
  <div class="container">
    <div class="search-wrapper">
      <div class="name-filter-wrapper">
        <input v-model="searchText" @change="refreshObjects" class="name-filter" type="text"
          placeholder="Search by name">
        <img src="../../assets/imgs/search-icon.png">
      </div>
      <div class="mark-filter-wrapper">
        <input v-model="searchedAverageMark" @change="refreshObjects" class="mark-filter" type="text"
          placeholder="Mark">
        <img src="../../assets/imgs/search-icon.png">
      </div>
