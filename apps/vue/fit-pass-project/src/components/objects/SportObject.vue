...
<template>
  <div class="object-wrapper" @click="showObject">
    ...
    <div class="object-info">
      ...
      <div class="address">
        <label for="">{{ sportObjectChild.location.address.street + " " + sportObjectChild.location.address.number
            + ", "
        
            + sportObjectChild.location.address.city
        }}</label>
      </div>
      <div class="type">
      ...
      <div class="status-and-time">
        ...
        <label for="" class="time" v-on:mouseover="displayWorkTime = true;"
          v-on:mouseleave="displayWorkTime = false;">{{ currentWorkTime }}</label>
      </div>
    </div>
